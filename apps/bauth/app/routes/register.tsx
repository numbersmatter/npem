...
import { authClient, signIn, signUp } from "~/services/auth/auth_client";



export async function loader() {

  // This function can be used to load any data needed for the register page
...
export async function clientAction({ request }: Route.ClientActionArgs) {
  ...
  const redirectTo = url.searchParams.get("redirectTo") || "/protected";
      ...
      <div>
        ...
        <div className="mt-6 grid grid-cols-2 gap-4">
          ...
          >
            ...
            <span className="text-sm/6 font-semibold">Test</span>
          </button>
