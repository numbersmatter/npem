...
//   callbackURL.pathname = "/protected";
...
//     // asResponse: true, // This will return the response object instead of just the session
//   });

//   return redirect("/protected"); // Return the response directly, or handle it as needed
// };
